...
- **Rare useful features**: destructuring, list comprehensions, expression blocks, guarded match expressions, match-as-expression, integer `try`/`rescue` exception handling, `once`, `maybe`, array iteration, and `trace`.
