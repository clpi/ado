...
local ado_root = "/Users/clp/x/dopl"
local duo_root = "/Users/clp/x/dopl"
local cry_root = "/Users/clp/x/crystal-lsp"

-- Load syntax highlighting
vim.cmd("set runtimepath+=" .. ado_root .. "/ext/vim")
vim.cmd("set runtimepath+=" .. duo_root .. "/ext/vim")
vim.cmd("set runtimepath+=" .. cry_root .. "/ext/vim")
...
vim.lsp.config("ado-lsp", {
	cmd = { "/usr/local/bin/ado-lsp" },
	root_markers = { ".git/" },
	filetypes = { "ado" },
	settings = {},
})
vim.lsp.config("crystal-lsp", {
	cmd = { "/Users/clp/x/crystal-lsp/crystal_lsp" },
	filetypes = { "crystal" },
	root_markers = { "shard.yml", "shard.yaml", ".git" },
	settings = {},
})
vim.lsp.enable("crystal-lsp")
